...
<div class="form-group text-right">
    @role('Supervisor')
    <button type="submit" class="btn btn-primary text-right" name="save_remarks"><i class="fe fe-send"></i> Submit</button>    @endrole @role('Deputy Dean')
    <button type="submit" class="btn btn-success text-right" name="approve"><i class="fe fe-send"></i> Approve</button>
    <button type="submit" class="btn btn-danger text-right" name="reject"><i class="fe fe-send"></i> Reject</button> @endrole
</div>
@endif 
@isset($remarks)
