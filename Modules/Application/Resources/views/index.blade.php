...
<div class='card'>
    <div class='card-header'>
        ...
        <div class="card-options">
            <a class="btn btn-secondary btn-sm">Total: {{ $applications->count() }} {{ str_plural('Application',
                $applications->count()) }}</a> @can('add_applications')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ URL::signedRoute('applications.show', ['id' => $application->id])  }}" class="btn btn-secondary btn-sm"><i
                                    class="fe fe-eye"></i> View</a> @endcan
                            ...
                            @can('delete_applications') {!! Form::open( ['method' => 'delete', 'url' =>
                            route('applications.destroy',
                            ['id' => $application->id]), 'style' => 'display: inline', 'onSubmit' => 'return
                            confirm("Are
