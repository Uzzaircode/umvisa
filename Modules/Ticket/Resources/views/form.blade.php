...
<div class="row">
                    ...
                    <div class="row gutters-sm" id="attachment">
                            ...
                            <div class="col-6 col-sm-4">
                              ...
                              <a href="{{asset($t->path)}}" data-toggle="lightbox" data-gallery="attachment-gallery">
                                ...
                                @endif                      
                                @if(pathinfo($t->path, PATHINFO_EXTENSION) == 'doc' || pathinfo($t->path, PATHINFO_EXTENSION) == 'docx')
                                <a href="{{asset($t->path)}}">
                                <img src="{{asset('img/file-icons/doc.png')}}" alt="" width="128px">
                                </a>
                                @elseif(pathinfo($t->path, PATHINFO_EXTENSION) == 'pdf')
                                <a href="{{asset($t->path)}}">
                                    <img src="{{asset('img/file-icons/pdf.png')}}" alt="">
                                    </a>
                                @elseif(pathinfo($t->path, PATHINFO_EXTENSION) == 'xls' || pathinfo($t->path, PATHINFO_EXTENSION) == 'csv' )
                                    <a href="{{asset($t->path)}}">
    ...
    <div class="col-lg-6 col-md-12" >
            <div class="card"> 
                    @cardHeader 
                    @slot('card_title')
                    <i class="fe fe-message-circle"></i> Comments @endslot 
                    @endcardHeader 
                    @cardBody   
