...
<title>#{{$ticket->ticket_number}} : {{ucfirst($ticket->subject)}}</title>
	<style type="text/css">
													...
													<td width="600" align="center">
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable" align='left'>
																<p>Hi {{ucfirst($ticket->user->name)}},
																	<br/>
																	<br/> {{ ucfirst($user->name) }} just published a ticket and would like you to review it. The details are as below;
																	<hr>
																</p>
																<p>
																	<b>Created At:</b> {{$ticket->created_at->toDayDateTimeString()}}
																</p>
																<p>
																	<b>Type:</b> {{ucfirst($ticket->ticket_type)}}
																</p>
																<p>
																	<b>Subject:</b> {{ucfirst($ticket->subject)}}
																</p>
																<p>
																	<b>Department:</b> {{ucfirst($ticket->department->name)}}
																</p>
																<p>
																	<b>SAP Module:</b> {{ucfirst($ticket->sap->name)}}
																</p>
																@if($ticket->integration == 1)
																<p>
																	<b>Integration:</b> {{$ticket->integration ? 'Yes':'No'}}
																</p>
																<p>
																	<b>Application:</b> {{$ticket->application->name}}
																</p>
																@endif
																<p>
																	<b>Issue: </b>
																...
																<td valign="top" width='34'>
																	<div class="contentEditableContainer contentFacebookEditable" style='display:inline;'>
																		<div class="contentEditable">
																			<img src="images/facebook.png" data-default="placeholder" data-max-width='30' data-customIcon="true" width='30' height='30'
																			    alt='facebook' style='margin-right:40x;'>
																		</div>
																	</div>
																</td>
																<td valign="top" width='34'>
																	<div class="contentEditableContainer contentTwitterEditable" style='display:inline;'>
																		<div class="contentEditable">
																			<img src="images/twitter.png" data-default="placeholder" data-max-width='30' data-customIcon="true" width='30' height='30'
																			    alt='twitter' style='margin-right:40x;'>
																		</div>
																	</div>
																</td>
																<td valign="top" width='34'>
